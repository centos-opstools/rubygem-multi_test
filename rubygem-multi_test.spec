...
Version: 0.1.2
Release: 4%{?dist}
Summary: Wafer-thin gem to disable autorun of various testing libraries
...
%changelog
* Thu Sep 22 2016 Rich Megginson <rmeggins@redhat.com> - 0.1.2-4
- only require runtime when building for scl

* Thu Sep 22 2016 Rich Megginson <rmeggins@redhat.com> - 0.1.2-3
